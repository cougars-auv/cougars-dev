...
alias vcs-import="~/cougars-dev/deploy/import.sh"
alias docker-pull="docker compose -f ~/cougars-dev/deploy/docker-compose.yaml pull"
alias build="docker compose -f ~/cougars-dev/deploy/docker-compose.yaml run --rm builder"
