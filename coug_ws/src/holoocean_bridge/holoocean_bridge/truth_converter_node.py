...
class TruthConverterNode(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter("holoocean_origin", [0.0, 0.0, 0.0])
        ...
        self.holoocean_origin = (
            self.get_parameter("holoocean_origin").get_parameter_value().double_array_value
        )
    ...
    def sync_callback(self, location_msg: PoseWithCovarianceStamped, imu_msg: Imu):
        ...
        t_map_com.transform.translation.x = (
            location_msg.pose.pose.position.x - self.holoocean_origin[0]
        )
        t_map_com.transform.translation.y = (
            location_msg.pose.pose.position.y - self.holoocean_origin[1]
        )
        t_map_com.transform.translation.z = (
            location_msg.pose.pose.position.z - self.holoocean_origin[2]
        )
        t_map_com.transform.rotation = imu_msg.orientation
