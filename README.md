...
- **Update Package Versions:** Before tagging, update the `<version>` in `package.xml` for each package in `cougars-dev` without its own repository. Match the release branch (e.g., `1.2.3`). Commit and push your updates.
