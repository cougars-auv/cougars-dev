...
base_station="true"
case ${scenario} in
  "CougUV") agent_list=$(agents_yaml coug1sim);;
  "BlueROV2") agent_list=$(agents_yaml blue1sim); base_station="false";;
  "Multi-Agent") agent_list=$(agents_yaml coug1sim coug2sim coug3sim);;
esac
